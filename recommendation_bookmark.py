...
#TODO: this part of code is still manual  & not integrate to the pipeline

#citation: Pinecone recommender: https://docs.pinecone.io/docs/personalized-content-recommendations, https://hackernoon.com/build-an-article-recommendation-engine-using-machine-learning
